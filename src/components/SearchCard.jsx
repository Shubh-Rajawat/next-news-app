...
const SearchCard = ( { data } ) => {
    ...
    return (
        <Card sx={ { minHeight: "calc( 100vh - 140px )", border: 0, boxShadow: 0, textAlign: "start" } } className={ `h-full flex flex-col items-center justify-center w-full  bg-inherit border-r  border-gray-300` }   >
            { readID !== data?.id ?
